...
#保持以下不混淆 项目相关
-dontwarn site.duqian.wchook.UI.**
...
#xposed
-dontwarn  site.duqian.wchook.xposed.**
-keep class site.duqian.wchook.xposed.**{*;}

-keep class site.duqian.wchook.wechat.**{*;}

-keep class site.duqian.wchook.model.**{*;}
-keep class site.duqian.wchook.database.** { *; }
-keep class site.duqian.wchook.base.**{*;}
